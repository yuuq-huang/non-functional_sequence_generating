...
#     tm_low=0
#     tm_high=0
#     constraints=[{'position':0,'range':len(seq),'tm':[tm_low,tm_high],'GC':[gc_low,gc_high]},{'position':20,'range':20,'tm':[0,0],'GC':[0.50,0.55]}]
# 
#     # Hammerhead Nielsen Paper
#     seq         = 'NNNNN NNNNNN NNNNNNN NNNNN NNNNNN NNNNN NNNN NNNN NNNN NNNN NNNC NNNN NNNNN NNNN NNNNN NNNN NNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN CGTGA' # Nielsen Like
#     seq         = ''.join(seq.split(' '))
#     output_file = None #'riboz.fa'
#     background_list = None #utils.get_fasta_seq_list(fasta_filename='input.fa.bk104')
# =============================================================================
    homology = 16
    seq         = 'NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN NNNNN' # Nielsen Like
    seq         = ''.join(seq.split(' '))
    output_file = None #'riboz.fa'
    ...
    inter_MFE=-11.0
    SW_score=90
    constraints={'cons':[{'position':0,'range':len(seq),'tm':[tm_low,tm_high],'GC':[gc_low,gc_high]}]}
    
    
    t0 = time()
    sm_obj = SeqMaker(seed=7)
    toolbox = sm_obj.non_coding_maker(homology,constraints, [seq], seq_list,[100],
